                        ...
                        <div class="card">
                            <form class="form-horizontal" id="form1" method="post" action="{{route('company.save')}}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" class="form-control" name="email"
                                                   value="{{$company->email}}" id="email" placeholder="Email Here"
                                                   required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="website" id="cono1"
                                                   value="{{$company->website}}" placeholder="Website Here" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div class="border-top">
                                    <div class="card-body">
                                        <button type="submit" class="btn btn-submit btn-primary offset-2">
                                            Update
